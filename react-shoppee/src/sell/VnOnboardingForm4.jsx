...
export default function VnOnboardingForm4() {
        ...
        <div className="container-VnOnboarding">
            <div className="hearder-banhang-shopee">
                ...
                <div className="parent-container-VnOnboarding-form">
                    <div className="onboarding-steps-form4">
                        <div className="onboarding-steps__wrap-form4">
                            <div className="onboarding-steps__item-form4">
                                <div className="eds-step-form4">
                                    <div className="eds-step__head-dot-form4" />
                                    <div className="eds-step__tail-form4" />
                                    <div className="eds-step__content-form4">
                                        Thông tin Shop
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="check-onboarding-streps-form4">
                        <i
                            class="far fa-check-circle fa-check-circle-onboarding-streps-form4"
                            style={{ fontSize: "128px" }}
                        ></i>
                        <span className="span-onboarding-streps-form4">
                            Đăng ký thành công
                        </span>
                        <span className="span-onboarding-streps-form4">
                            Hãy đăng bán sản phẩm đầu tiên để khởi động hành
                            trình bán hàng cùng Shopee nhé!
                        </span>
                        <button className="button-onboarding-streps-form4">
                            <span>
                                <a
                                    href="/sell/product/new"
                                    style={{ color: "white" }}
                                >
                                    Thêm sản phẩm
                                </a>
