...
export default function VnOnboarding() {
    return (
        <div className="container-VnOnboarding">
            <div className="hearder-banhang-shopee">
                ...
                <div className="parent-container-VnOnboarding">
                    <div
                        data-v-14789528
                        data-v-bed2a820
                    ...
                    >
                        ...
                        >
                            ...
                            />{" "}
                            <h3 className="onboarding-welcome__title">
                                Chào mừng đến với Shopee!
                            </h3>{" "}
                            <p className="onboarding-welcome__desc">
                                Vui lòng cung cấp thông tin để thành lập tài
                                khoản người bán trên Shopee
                            </p>{" "}
                            <button
                                data-v-2e4150da
                                type="button"
                                ...
                                className="onboarding-welcome__btn eds-button eds-button--primary eds-button--normal"
                            >
