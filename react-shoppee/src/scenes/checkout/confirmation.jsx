        ...
        <div className="Ts66FD" style={{}}>
            <div className="iAQnc1">
                <div className="container">
                    <div className="tfMaBS">
                        <a className="fQqDFE" href="/">
                            <svg
                                viewBox="0 0 192 65"
                            ...
                            <h1 className="cE_Tbx">Thanh toán</h1>
                        </a>
                    </div>
                </div>
            </div>
            <div role="main" className="HYmUPs">
                            ...
                            <div>
                                <div className="y0jyrJ">
                                    <div className="PzGLCh">
                                        Lê Khang (+84) 373708308
                                    </div>
                                    <div className="a9c4OR">
                                        Tổ 4 Thôn 1, Xã Bình Tú, Huyện Thăng
                                        Bình, Quảng Nam
                                    </div>
                                    <div className="dIzOca">Mặc định</div>
                                </div>
                            </div>
                            <button className="VNkBIJ div-style">
                                Thay đổi
                            </button>
                        </div>
                        <div />
                ...
                <div className="UWJJw6">
                    <div className="kvWjhK">
                        <div className="iSSCtq">
                            ...
                            <div className="k7UefF zQOVG9" />
                            <div className="k7UefF la0Ej7">Đơn giá</div>
                            <div className="k7UefF Ljo_XM">Số lượng</div>
                    ...
                    <div>
                        <div className="QroV_K">
                            ...
                            <div className="G6NNuz">
                                <div className="vUgn8f">
                                    <h3 className="o13Lc4 hERTPn XxP4Un">
                                        <div>
                                            Tổng số tiền ({productCount} sản
                                            phẩm):
                                        </div>
                                    </h3>
                                    <div className="o13Lc4 X9R_0O XxP4Un gZZW8b noAtfs">
                                        {itemTotal}
                                    </div>
                                </div>
                            </div>
                ...
                <div className="n4Xm74">
                    <div className="uFatmV">
                        <div className="Y97ZiC">
                            <div className="l7HLsB">
                                <div className="FqCg1s">
                                    <svg
                                        fill="none"
                                        viewBox="0 -2 23 22"
                                        className="shopee-svg-icon icon-voucher-line"
                                    ...
                                    <h2 className="QPM2zr">Shopee Voucher</h2>
                                </div>
                            </div>
                        </div>
                        <div className="fJ3ua1">
                            <button className="FJus8T">Chọn Voucher</button>
                        </div>
                    </div>
                    <div className="xXAZKT">
                        <div className="WKU8am">
                            <svg
                                fill="none"
                                viewBox="0 0 18 18"
                                className="shopee-svg-icon WZCJnB icon-coin-line"
                            >
                                <path
                                    stroke="#FFA600"
                                    strokeWidth="1.3"
                            ...
                            <h2 className="hRvI7W">Shopee Xu</h2>
                            <div className="Bdw8UC">Không thể sử dụng Xu</div>
                        </div>
                        <div className="HT473_">
                            <div className="fblgoK">[-₫0]</div>
                ...
                <div className="N02iLl">
                    <div className="aSiS8B">
                        <h2 className="a11y-visually-hidden">
                        ...
                        <div className="IN_fAG">
                            ...
                            <button className="BM_J3y div-style">
                                Thay đổi
                            </button>
                        </div>
                    </div>
                    <div className="yHG0SE" aria-live="polite">
                        ...
                        <div className="o13Lc4 X9R_0O fwPZIN">₫42.500</div>
                        <h3 className="o13Lc4 hERTPn cNgneA">
                            Tổng thanh toán
                        </h3>
