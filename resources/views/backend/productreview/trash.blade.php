...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Thùng rác đánh giá sản phẩm</h1>
        </div>
        <div class="col-sm-6">
                    ...
                    <tr>
                      ...
                      @endphp
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.productreview.restore', $args ) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-undo"></i>
                            </a>
                            <form action="{{ route('admin.productreview.destroy', $args ) }}" method="post" class="d-inline" >
                                @csrf
                                @method('delete')
